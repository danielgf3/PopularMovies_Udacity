...
public class PMDateUtil {
    ...
    public static Date getDate(String date){
        ...
        if(date.contains("-")) formatter = new SimpleDateFormat("yyyy-MM-dd");
        else formatter = new SimpleDateFormat("yyyyMMdd");
        try {
    ...
    public static String dateToString(Context context, Date date, boolean showFullDate){
        return getFriendlyDateString(context, date.getTime(), showFullDate);
    }
